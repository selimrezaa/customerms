...
define('TITLE','Login');
	...
	if(isset($_REQUEST['aemail'])){
		...
		$sql = "SELECT aemail, apassword FROM admin_table WHERE aemail = '".$_REQUEST['aemail']."' AND apassword = '".$_REQUEST['apassword']."' limit 1";
...
<p class="text-center text-danger mt-2" style="font-size: 20px;"> <i class="fa fa-user-secret"></i> Admin Area (Demo)</p>
		...
		<div class="col-sm-6 col-md-4">
			<form method="POST" action="" class="shadow-lg p-4">
				<div class="form-group">
					...
					<input type="email" name="aemail" placeholder="Eamil" class="form-control">
				...
				<button class="btn btn-outline-danger btn-block font-weight-bold text-center mt-4 shadow" name="adminLogin">Login</button>
